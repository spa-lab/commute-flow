...
// Age @--@ Age 50-64 @--@ 50-64
//
// ModeOfTravel @--@ Train @--@ Train
// ModeOfTravel @--@ Bus @--@ Bus
// ModeOfTravel @--@ Drive Car @--@ Car
// ModeOfTravel @--@ Bike @--@ Bike
// ModeOfTravel @--@ Walk @--@ Walk
//
// Socioeconomic @--@ Higher managerial and administrative @--@ Higher managerial & admin
// Socioeconomic @--@ Higher professional @--@ Higher professional
// Socioeconomic @--@ Lower professional and higher technical @--@ Lower professional & higher technical
// Socioeconomic @--@ Lower managerial and administrative @--@ Lower managerial & admin
// Socioeconomic @--@ Higher supervisory @--@ Higher supervisory
// Socioeconomic @--@ Intermediate occupations @--@ Intermediate occupations
// Socioeconomic @--@ Lower supervisory @--@ Lower supervisory
// Socioeconomic @--@ Lower technical @--@ Lower technical
// Socioeconomic @--@ Semi-routine @--@ Semi-routine
// Socioeconomic @--@ Routine @--@ Routine
//
// Industry @--@ Manufacturing @--@ Manufacturing
// Industry @--@ Construction @--@ Construction
// Industry @--@ Retail_Rep @--@ Retail & Repair
// Industry @--@ Transport and storage @--@ Transport & storage
// Industry @--@ Accommodation and food services @--@ Accommodation & food services
// Industry @--@ Finance @--@ Finance
// Industry @--@ Professional, scientific and technical @--@ Professional, scientific & technical
// Industry @--@ Administrative and support services @--@ Administrative & support services
// Industry @--@ Public administration and defence; compulsory social security @--@ Public administration & defence; compulsory social security
// Industry @--@ Education @--@ Education
// Industry @--@ Human health and social work @--@ Human health & social work
// Industry @--@ Managers, directors and senior officials @--@ Managers, directors & senior officials
//
// Occupation @--@ Professional occupations @--@ Professional
// Occupation @--@ Associate professional and technical occupations @--@ Associate professional & technical
// Occupation @--@ Administrative and secretarial occupations @--@ Administrative & secretarial
// Occupation @--@ Skilled trades occupations @--@ Skilled trades occupations
// Occupation @--@ Caring, leisure and other service occupations @--@ Caring, leisure & other service
// Occupation @--@ Sales and customer service occupations @--@ Sales & customer service
// Occupation @--@ Process, plant and machine operatives @--@ Process, plant & machine operatives
// Occupation @--@ Elementary occupations @--@ Elementary
//
// HoursWorked @--@ Part-time: 15 or less worked @--@ < 16
// HoursWorked @--@ Part-time: 16 to 30 hours worked @--@ 16 – 30
// HoursWorked @--@ Full-time: 31 to 48 hours worked @--@ 31 – 48
// HoursWorked @--@ Full-time: 49 or more hours worked @--@ > 48
//
// SocialGrade @--@ Approx. social grade AB @--@ AB
// SocialGrade @--@ Approx. social grade C1 @--@ C1
// SocialGrade @--@ Approx. social grade C2 @--@ C2
// SocialGrade @--@ Approx. social grade DE @--@ DE
...
var Diagrams = {
  ...
  createRadialDiagrams: function() {

    for (let group in this.groupData) {
      if (this.groupData.hasOwnProperty(group)) {
        this.createRadialDiagram(group);
      }
    }

  },

  createRadialDiagram: function(group) {
