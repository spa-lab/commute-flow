...
var Diagrams = {
  ...
  labels: [
    ...
    'Higher professional',
    'Lower professional & higher technical',
    'Lower managerial and admin',
    'Higher supervisory',
  ...
  data: {
    g1: [-0.2898335, -0.5652861, -0.2821526, -0.5806601, -0.6897176, -0.0081818, 0.0553240, -0.0946947, 0.2490915, -0.0380303, 0.9262800, 0.2125665, -0.7810907, -0.4459161, -0.0758261, -0.0518984, 0.1609955, 1.5060163, -0.0470359, 0.6210566, 0.9686828, 0.0054915, -0.4538302, -0.2901564, -0.0189297, 0.8382217, -0.6310537, 0.2251787, 0.7129810, 0.8823794, 0.7680842, -0.7551477, -0.4587101, -0.2480418, -0.1612248, 1.1801495, 0.0466582, 0.6508536, 0.0567176, -0.2260128, 0.1362883, -0.1332603, -0.2018477, -0.1527481, -0.1707232, -0.6757754, -0.0836405, 0.0983691, 0.8167342],
    g11: [],
    g12: [],
    g13: [],
    g14: [],
  ...
  createRadialDiagram: function(isSuperGroup) {
    ...
    if (isSuperGroup) {
      ...
      this.createSuperGroupsRadialDiagram2('g1');
      // this.createChartJS();
    }
    else {
  ...
  createSuperGroupsRadialDiagram: function() {

    var dataDiagram = echarts.init(document.getElementById('dataDiagram'));

    let option = {
      title : {
        text: 'Consumer Services', // TODO: Change this !!!
        subtext: 'Radar Diagram' // TODO: Change this !!!
      },
      tooltip : {
        //formatter: '{a}',
        // islandFormatter: '{a}',
      ...
      polar : [
        {
          indicator : [
            ...
            // { text: 'Male', max: 1.6 },
            // { text: 'White', max: 1.6 },
            // { text: 'Age 16-24', max: 1.6 },
            // { text: 'Age 25-34', max: 1.6},
            // { text: 'Age 35-49', max: 1.6 },
            // { text: 'Age 50-64', max: 1.6 },
            // { text: 'Train', max: 1.6 },
            // { text: 'Bus', max: 1.6 },
            // { text: 'Drive Car', max: 1.6 },
            // { text: 'Bike', max: 1.6 },
            // { text: 'Walk', max: 1.6 },
            // { text: 'Higher managerial and administrative', max: 1.6 },
            // { text: 'Higher professional', max: 1.6 },
            // { text: 'Lower professional and higher technical', max: 1.6 },
            // { text: 'Lower managerial and administrative', max: 1.6 },
            // { text: 'Higher supervisory', max: 1.6 },
            // { text: 'Intermediate occupations', max: 1.6 },
            // { text: 'Lower supervisory', max: 1.6 },
            // { text: 'Lower technical', max: 1.6 },
            // { text: 'Semi-routine', max: 1.6 },
            // { text: 'Routine', max: 1.6 },
            // { text: 'Manufacturing', max: 1.6 },
            // { text: 'Construction', max: 1.6 },
            // { text: 'Retail Rep', max: 1.6 },
            // { text: 'Transport and storage', max: 1.6 },
            // { text: 'Accommodation and food services', max: 1.6 },
            // { text: 'Finance', max: 1.6 },
            // { text: 'Professional, scientific and technical', max: 1.6 },
            // { text: 'Administrative and support services', max: 1.6 },
            // { text: 'Public administration and defence; compulsory social security', max: 1.6 },
            // { text: 'Education', max: 1.6 },
            // { text: 'Human health and social work', max: 1.6 },
            // { text: 'Managers, directors and senior officials', max: 1.6 },
            // { text: 'Professional occupations', max: 1.6 },
            // { text: 'Associate professional and technical occupations', max: 1.6 },
            // { text: 'Administrative and secretarial occupations', max: 1.6 },
            // { text: 'Skilled trades occupations', max: 1.6 },
            // { text: 'Caring, leisure and other service occupations', max: 1.6 },
            // { text: 'Sales and customer service occupations', max: 1.6 },
            // { text: 'Process, plant and machine operatives', max: 1.6 },
            // { text: 'Elementary occupations', max: 1.6 },
            // { text: 'Part-time: 15 or less worked', max: 1.6 },
            // { text: 'Part-time: 16 to 30 hours worked', max: 1.6 },
            // { text: 'Full-time: 31 to 48 hours worked', max: 1.6 },
            // { text: 'Full-time: 49 or more hours worked', max: 1.6 },
            // { text: 'Approx. social grade AB', max: 1.6 },
            // { text: 'Approx. social grade C1', max: 1.6 },
            // { text: 'Approx. social grade C2', max: 1.6 },
            ...
            // { text: 'White', max: 1.5 },
            //
            // { text: 'Higher managerial & admin', max: 1.5 },
            // { text: 'Higher professional', max: 1.5 },
            // { text: 'Lower professional & higher technical', max: 1.5 },
            // { text: 'Lower managerial and admin', max: 1.5 },
            // { text: 'Higher supervisory', max: 1.5 },
            // { text: 'Intermediate occupations', max: 1.5 },
            // { text: 'Lower supervisory', max: 1.5 },
            // { text: 'Lower technical', max: 1.5 },
            // { text: 'Semi-routine', max: 1.5 },
            // { text: 'Routine', max: 1.5 },
            //
            // { text: 'Professional', max: 1.5 },
            // { text: 'Associate professional & technical', max: 1.5 },
            // { text: 'Administrative & secretarial', max: 1.5 },
            // { text: 'Skilled trades occupations', max: 1.5 },
            // { text: 'Caring, leisure & other service', max: 1.5 },
            // { text: 'Sales & customer service', max: 1.5 },
            // { text: 'Process, plant & machine operatives', max: 1.5 },
            // { text: 'Elementary', max: 1.5 },
            //
            // { text: '16-24', max: 1.5 },
            // { text: '25-34', max: 1.5 },
            // { text: '35-49', max: 1.5 },
            ...
            // { text: '> 48', max: 1.5 },
            //
            // { text: 'Manufacturing', max: 1.5 },
            // { text: 'Construction', max: 1.5 },
            // { text: 'Retail & Repair', max: 1.5 },
            // { text: 'Transport & storage', max: 1.5 },
            // { text: 'Accommodation & food services', max: 1.5 },
            // { text: 'Finance', max: 1.5 },
            // { text: 'Professional, scientific & technical', max: 1.5 },
            // { text: 'Administrative & support services', max: 1.5 },
            // { text: 'Public admin & defence; compulsory social security', max: 1.5 },
            // { text: 'Education', max: 1.5 },
            // { text: 'Human health & social work', max: 1.5 },
            // { text: 'Managers, directors & senior officials', max: 1.5 },
            //
            // { text: 'AB', max: 1.5 },
            // { text: 'C1', max: 1.5 },
            // { text: 'C2', max: 1.5 },
      ...
      series : [
        {
          name: '*** Supergroup data ***', // TODO: Change this !!!
          type: 'radar',
          data : [
            {
              // TODO: Reorder the values to match the labels !!!
              value : [-0.2898335, -0.5652861, -0.2821526, -0.5806601, -0.6897176, -0.0081818, 0.0553240, -0.0946947, 0.2490915, -0.0380303, 0.9262800, 0.2125665, -0.7810907, -0.4459161, -0.0758261, -0.0518984, 0.1609955, 1.5060163, -0.0470359, 0.6210566, 0.9686828, 0.0054915, -0.4538302, -0.2901564, -0.0189297, 0.8382217, -0.6310537, 0.2251787, 0.7129810, 0.8823794, 0.7680842, -0.7551477, -0.4587101, -0.2480418, -0.1612248, 1.1801495, 0.0466582, 0.6508536, 0.0567176, -0.2260128, 0.1362883, -0.1332603, -0.2018477, -0.1527481, -0.1707232, -0.6757754, -0.0836405, 0.0983691, 0.8167342],
              name : '*** Test 1 ***' // TODO: Change this !!!
            }
          ]
        }
      ]
  ...
  createSuperGroupsRadialDiagram2: function(group) {
...
$(window).on('resize', function(){
  if(dataDiagram != null && dataDiagram != undefined){
    dataDiagram.resize();
  }
});
